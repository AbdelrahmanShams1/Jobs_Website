...
const JobListing = ({job}) => {
    const [LessDesc,setLesDesc] = useState(true)
  ...
  return (
    ...
    <div className="p-4">
      ...
      <button className='mb-5 text-indigo-500 hover:text-indigo-600' onClick={() =>{
      setLesDesc(!LessDesc) }}>{LessDesc ? "More" : "Less"}</button>
